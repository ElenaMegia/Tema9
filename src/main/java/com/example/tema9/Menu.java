...
import com.example.tema9.ejercicio1.Ejercicio1;
import com.example.tema9.ejercicio2.Ejercicio2;
    ...
    public static void switchOptions() throws InputMismatchException {
        ...
        do {
            try {
                ...
                System.out.println("\nMenu:\n"
                        + "1º Ejercicio 1, El alquiler de bicis.\n"
                        + "2º Ejercicio 2,  Velocidad media versión plurilingüe.\n"
                        + "0º Salir\n"
